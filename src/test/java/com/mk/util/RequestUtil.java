...
public class RequestUtil {
  public static UserDto getRegisterUserDto(String email, String firstName, String lastName) {
    return UserDto.builder().email(email).password("password").firstName(firstName).lastName(lastName).build();
  }

  public static LoginUserDto getLoginUserDto() {
    return LoginUserDto.builder().email("test@test.com").password("password").build();
  }
