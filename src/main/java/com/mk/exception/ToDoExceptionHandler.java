...
public class ToDoExceptionHandler {
	...
	public Object handleException(Exception exception) {
		...
		return ApiResponse.builder()
						.error(ErrorInfo.builder().code(ErrorConstants.SERVICE_EXCEPTION)
										.message(ErrorConstants.SERVICE_EXCEPTION_MESSAGE).build())
						.build();
	}
	...
	public Object handleAccessDeniedException(Exception exception) {
		log.error("Something went wrong: ", exception);
		return ApiResponse.builder()
						.error(ErrorInfo.builder().code(ErrorConstants.ACCESS_DENIED)
										.message(ErrorConstants.ACCESS_DENIED_MESSAGE).build())
						.build();
	}
	...
	public Object handleCustomException(ServiceException ex) {
		...
		return ApiResponse.builder()
						.error(ErrorInfo.builder().code(ex.getErrorCode())
										.message(ex.getErrorMessage()).build()).build();
	}
	...
	public Object handleValidationExceptions(MethodArgumentNotValidException ex) {
		...
		ex.getBindingResult().getAllErrors().forEach((error) -> {
			...
			errors.add(ErrorInfo.builder().code(fieldName).message(errorMessage)
							.build());
		});
